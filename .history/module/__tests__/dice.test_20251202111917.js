...
test("_getColumnShifts returns the correct number of column shifts", () => {
  ...
  expect(dice._getColumnShifts(2, dice._getRangeIndex(15), dice._getRangeIndex(1), actionTable)).toBe(0);
   ...
   // Low total giving +1 CS
//  expect(dice._getColumnShifts(5, dice._getRangeIndex(8), dice._getRangeIndex(6), actionTable)).toBe(3);

expect(dice._getColumnShifts(2, dice._getRangeIndex(15), dice._getRangeIndex(1), actionTable)).toBe(0);
expect(dice._getColumnShifts(25, dice._getRangeIndex(1), dice._getRangeIndex(15), actionTable)).toBe(0);
expect(dice._getColumnShifts(3, dice._getRangeIndex(5), dice._getRangeIndex(5), actionTable)).toBe(1);
expect(dice._getColumnShifts(5, dice._getRangeIndex(8), dice._getRangeIndex(6), actionTable)).toBe(3);
expect(dice._getColumnShifts(8, dice._getRangeIndex(7), dice._getRangeIndex(7), actionTable)).toBe(2);
expect(dice._getColumnShifts(11, dice._getRangeIndex(10), dice._getRangeIndex(9), actionTable)).toBe(4);
expect(dice._getColumnShifts(29, dice._getRangeIndex(6), dice._getRangeIndex(8), actionTable)).toBe(3);
expect(dice._getColumnShifts(19, dice._getRangeIndex(2), dice._getRangeIndex(12), actionTable)).toBe(-5);
expect(dice._getColumnShifts(2, dice._getRangeIndex(18), dice._getRangeIndex(17), actionTable)).toBe(1);
expect(dice._getColumnShifts(2, dice._getRangeIndex(9), dice._getRangeIndex(9), actionTable)).toBe(0);
expect(dice._getColumnShifts(14, dice._getRangeIndex(11), dice._getRangeIndex(8), actionTable)).toBe(7);
